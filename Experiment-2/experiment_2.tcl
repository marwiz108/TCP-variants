...
# TCP/... TCP/...
append trace_file_name "Newreno" _ "Reno"
append trace_file_name _$cbr_flow
append trace_file_name _$tcp1_start_time
append trace_file_name _$tcp2_start_time.tr

# Console log message
puts "$trace_file_name || Running Sim for TCP 1: Newreno | TCP 2: Reno | CBR: $cbr_flow | TCP 1 ST: $tcp1_start_time | TCP 2 ST: $tcp2_start_time"
...
set tcp_var1 [new Agent/TCP/Newreno]
...
set tcp_var2 [new Agent/TCP/Reno]
...
$ns at 12.0 "$cbr stop"
$ns at 12.0 "$ftp_stream1 stop"
$ns at 12.0 "$ftp_stream2 stop"
